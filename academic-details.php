...
<html lang="en">
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">MITWPU ERP
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 customColor">Academics</h1>
                        ...
                        <h2 class="customColor">Academic Details</h2>
                        ...
                        <?php
                        $baseq="SELECT s.studName,s.prn, m.subjectID, z.subjName from student s inner join marks m on
                        s.prn=m.prn inner join subjects z on m.subjectID=z.subjectID
                        order by s.prn;";
                        ...
                        <form method="post">
                            ...
                            class="button" value="View results" />
                    </div>
