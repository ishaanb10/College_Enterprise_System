            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 customColor">Projects</h1>
                        ...
                        <h2 class="customColor">Project Details</h2>
                        ...
                        <?php
                        $baseq="SELECT s.studName,s.prn, p.projID, p.started, p.organization, pr.projName, pr.mentor from student s inner join projectStudents p on
                        s.prn=p.prn inner join projectsInfo pr on p.projID=pr.projID
                        order by s.prn;";
                        ...
                        <form method="post">
                            ...
                            class="button" value="View Projects" />
                    </div>
